...
class CruiseWishlist extends StatefulWidget {
  CruiseWishlist({Key key}) : super(key: key);

  @override
  _CruiseWishlistState createState() => _CruiseWishlistState();
  save(WishlistItemModel item) {
    return createState().save(item);
  }
}

class _CruiseWishlistState extends State<CruiseWishlist> {
  List<Map> wishList = [];
  List<WishlistItemModel> cruiseList = [];
  bool isLoading = true;
  final _scaffoldKey = GlobalKey<ScaffoldState>();
  go() {
    cruiseList = Wishlist.cruiseList;
                    ...
                    child: Container(
                        child: cruiseList.length == 0
                            ...
                            : GridView.count(
                                ...
                                children:
                                    List.generate(cruiseList.length, (index) {
                                  return Center(
                                    child: Container(
                                      height: 150,
