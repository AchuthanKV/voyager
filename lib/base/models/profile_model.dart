...
//from individual info inner tag
  ...
  //from memberContactInfos innertag
  String _addressType;
  ...
  String get enrolmentSource => _enrolmentSource;
  ...
  set enrolmentDate(String value) => _enrolmentDate = value;

  String get periodType => _periodType;

  set periodType(String value) => _periodType = value;

  String get period => _period;

  set period(String value) => _period = value;

  String get extendToDay => _extendToDay;

  set extendToDay(String value) => _extendToDay = value;

  String get extendToMonth => _extendToMonth;
  ...
  set membershipType(String value) => _membershipType = value;
  ...
  String get memberNationality => _memberNationality;

  set memberNationality(String value) => _memberNationality = value;
  ...
  set initials(String value) => _initials = value;
  ...
  set preferredAddress(String value) => _preferredAddress = value;
  ...
  String get phoneISDCode => _phoneISDCode;

  set phoneISDCode(String value) => _phoneISDCode = value;

  String get phoneAreaCode => _phoneAreaCode;
  ...
  set faxISDCode(String value) => _faxISDCode = value;

  String get faxAreaCode => _faxAreaCode;

  set faxAreaCode(String value) => _faxAreaCode = value;

  String get fax => _fax;

  set fax(String value) => _fax = value;

  String get skypeID => _skypeID;

  set skypeID(String value) => _skypeID = value;
}
